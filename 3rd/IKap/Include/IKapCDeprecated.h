 ...
 */
    ...
    */
     ...
     * @note 特征的所有信息都存储在 ITKFEATURE 句柄中，包括特征名称、特征类型、参数范围等。
    */
    /**
   \~english
    ...
    */
     ...
     * - ITKSTATUS_INVALID_ARG
     * - ITKSTATUS_INVALID_HANDLE
     * @note 特征具体描述信息是一个描述节点及其目的的文本字符串，比 ItkDevGetTooltip 获取的信息更详细，传递给此函数的缓冲区必须足够容纳整个字符串。
...
/**
 \~chinese
  * @brief 事件类型【RO】
  * @note 本参数对应的pValue/value为 uint32_t 类型数据。
 */
 /**
\~english
 * @brief Event type [RO]
...
/**
 \~chinese
  * @brief 特征名称【RO】
  * @note 本参数对应的pValue/value为 char[128] 类型数据。
 */
 /**
\~english
...
/**
 \~chinese
  * @brief 主机时间戳【RO】
  * @note 本参数对应的pValue/value为 uint64_t 类型数据。
 */
 /**
\~english
...
/**
 \~chinese
  * @brief 事件数据【RO】
  * @note 本参数对应的pValue/value为 char[256] 类型数据。
 */
 /**
\~english
 ...
 * @deprecated 该接口已弃用，请使用 ItkEventGetInfo 代替。
*/
 /**
\~english 
