...
/**
\~chinese
 * @brief 是否使用CXP12协议【RW】
 * @note 本参数表示是否使用CXP12协议。
 * 1. 本参数默认支持CXP12协议。
...
*/
 /**
\~english
 * @brief Whether to use CXP12 protocol [RW]
 * @note This parameter indicates whether to use CXP12 protocol.
...
/**
\~chinese
 * @brief 是否支持CXP指令Tag【RW】
 * @note 本参数表示是否支持CXP指令Tag。
...
*/
 /**
\~english
 * @brief Whether to support CXP instruction Tag [RW]
 * @note This parameter indicates whether CXP instruction Tag is supported.
...
\~chinese
 * @brief CXP控制包最大尺寸【RW】
 * @note 本参数表示CXP控制包最大尺寸。
 * 1. 本参数对应的pValue/value为 uint32_t 类型数据。
*/
 /**
\~english
 * @brief CXP control packet maximum size [RW]
 * @note This parameter indicates the maximum size of CXP control packet.
 * 1. The corresponding pValue/value of this parameter is uint32_t type data.
 */
...
*/
 /**
\~english
 * @brief CXP stream packet maximum size [RW]
 * @note This parameter indicates the maximum size of CXP stream packet.
 * 1. The corresponding pValue/value of this parameter is uint32_t type data.
 */
...
/**
\~chinese
 * @brief CXP读写寄存器最大次数【RW】
 * @note 本参数表示CXP读写寄存器最大次数。
 * 1. 本参数对应的pValue/value为 uint32_t 类型数据。
*/
 /**
\~english
 * @brief CXP maximum number of read and write register operations [RW]
 * @note This parameter indicates the maximum number of CXP read and write register operations.
 * 1. The corresponding pValue/value of this parameter is uint32_t type data.
 */
...
/**
\~chinese
 * @brief 使能合并相同序列号相机【RW】
 * @note 本参数表示是否使能合并相同序列号相机功能，仅XGV采集卡具有合并相同序列号相机功能。
 * 1. 本参数对应的pValue/value为 uint32_t 类型数据。
*/
 /**
\~english
 * @brief Enable to merge the same serial number camera [RW]
 * @note This parameter indicates if enable to merge the same serial number camera, only XGVB can merge the same serial number camera.
 * 1. The corresponding pValue/value of this parameter is uint32_t type data.
 */
...
/**
\~chinese
 * @brief 设置GV相机探测时的超时时间【RW】
 * @note GV相机探测时的超时时间。
 * 1. 本参数对应的pValue/value为 uint64_t 类型数据。
*/
 /**
\~english
 * @brief Set the timeout time for GV camera detection [RW]
 * @note The timeout time for GV camera detection.
...
\~chinese
 * @brief 设备心跳包超时时间【RW】
 * @note 本参数表示设备心跳包超时时间，单位ms。
 * 1. 当调试千兆网相机设备时，可以增大该参数，保证相机不会因为未及时接受心跳包而停止工作。
 * 2. 本参数对应的pValue/value为 uint32_t 类型数据。
*/
 /**
\~english
 * @brief Device heartbeat timeout [RW]
 * @note This parameter indicates device heartbeat timeout, measured in milliseconds.
...
*/
 /**
\~english
 * @brief Device interface type [RO]
 * @note This parameter indicates device interface type.
 * 1. The corresponding pValue/value of this parameter is uint32_t type data.
 * 2. The parameter values and descriptions are as follows:
 * | Parameter value | Description          |
 * |-----------------|----------------------|
...
\~chinese
 * @brief 禁用心跳线程【RW】
 * @note 本参数表示禁用设备心跳线程，需要同时开启设备的DisableHeartBeat特征，否则设备会拒绝访问。
 * 1. 本参数对应的pValue/value为 uint32_t 类型数据。
 * 2. 参数取值及描述如下所示：
 * | 参数取值 | 描述           |
 * |----------|----------------|
...
*/
 /**
\~english
 * @brief Disable heartbeat thread [RW]
...
/**
\~chinese
 * @brief 禁用控制通道等待ACK【RW】
 * @note 本参数表示禁用控制通道等待ACK。
 * 1. 本参数对应的pValue/value为 uint32_t 类型数据。
 * 2. 参数取值及描述如下所示：
 * | 参数取值 | 描述                  |
 * |----------|-----------------------|
...
*/
 /**
\~english
 * @brief Disable control channel waiting for ACK [RW]
 * @note This parameter indicates that to disable control channel waiting for ACK.
 * 1. The corresponding pValue/value of this parameter is uint32_t type data.
 * 2. The parameter values and descriptions are as follows:
 * | Parameter value  | Description                              |
 * |------------------|------------------------------------------|
...
/**
\~chinese
 * @brief 相机控制通道操作超时时间【RW】
 * @note 本参数表示相机控制通道操作超时时间，单位ms。
 * 1. 本参数对应的pValue/value为 uint32_t 类型数据。
*/
 /**
\~english
 * @brief Camera control channel operation timeout time [RW]
 * @note This parameter indicates camera control channel operation timeout time and the unit is millisecond.
 * 1. The corresponding pValue/value of this parameter is uint32_t type data.
 */
...
*/
 /**
\~english
 * @brief Buffer data format [RW]
 * @note This parameter indicates buffer data format.
 * 1. The corresponding pValue/value of this parameter is uint32_t type data.
 */
...
*/
 /**
\~english
 * @brief Buffer width [RW]
 * @note This parameter indicates buffer width.
 * 1. The corresponding pValue/value of this parameter is uint64_t type data.
 */
...
*/
 /**
\~english
 * @brief Buffer height [RW]
 * @note This parameter indicates buffer height.
 * 1. The corresponding pValue/value of this parameter is uint64_t type data.
 */
...
*/
 /**
\~english
 * @brief Buffer address [RW]
 * @note This parameter indicates buffer address.
...
/**
\~chinese
 * @brief 缓冲区状态为满时的时间戳【RO】
 * @note 本参数表示缓冲区状态为满时的时间戳，该值受系统CPU时钟频率影响。
 * 1. 本参数对应的pValue/value为 uint64_t 类型数据。
*/
 /**
\~english
 * @brief Timestamp when buffer status is full [RO]
 * @note This parameter indicates timestamp when buffer state is full, which is affected by system CPU clock frequency.
 * 2. The corresponding pValue/value of this parameter is uint64_t type data.
 */
...
*/
 /**
\~english
 * @brief Buffer status [RO]
 * @note This parameter indicates buffer status.
...
\~chinese
 * @brief 缓冲区像素值有无符号【RO】
 * @note 本参数表示缓冲区像素值有无符号。
 * 1. 本参数无法设置，数值由缓冲区像素格式 ITKBUFFER_PRM_FORMAT 决定。
 * 2. 本参数对应的pValue/value为 uint32_t 类型数据。
*/
 /**
\~english
 * @brief Whether pixel value in buffer is signed or not [RO]
 * @note This parameter indicates whether pixel value in buffer is signed or not.
...
*/
 /**
\~english
 * @brief Buffer size [RO]
 * @note This parameter indicates buffer size.
 * 1. The corresponding pValue/value of this parameter is uint64_t type data.
 */
...
*/
 /**
\~english
 * @brief Buffer Index [RO]
 * @note This parameter indicates buffer index.
...
/**
\~chinese
 * @brief 缓冲区当前采集完成的行数【RO】
 * @note 本参数表示缓冲区当前采集完成的行数。
 * 1. 本参数对应的pValue/value为 uint64_t 类型数据。
*/
 /**
\~english
 * @brief The current number of lines grabbed in buffer [RO]
 * @note This parameter indicates the current number of lines grabbed in buffer.
 * 1. The corresponding pValue/value of this parameter is uint64_t type data.
 */
...
*/
 /**
\~english
 * @brief Reason for buffer error [RO]
 * @note This parameter indicates the reason for buffer error.
 * 1. The corresponding pValue/value of this parameter is uint32_t type data.
 */
...
*/
 /**
\~english
 * @brief Number of image resend packet in the current frame [RO]
 * @note This parameter indicates the number of image resend packet in the current frame.
 * 1. The corresponding pValue/value of this parameter is uint64_t type data.
 */
...
*/
 /**
\~english
 * @brief Current frame image packet loss count [RO]
 * @note This parameter indicates the current frame image packet loss count.
 * 1. The corresponding pValue/value of this parameter is uint64_t type data.
 */
...
*/
 /**
\~english
 * @brief Obtain the results of the edge search algorithm [RO]
 * @note This parameter indicates obtaining the results of the edge finding algorithm.
...
*/
 /**
\~english
 * @brief Exchange buffer width and height [WO]
...
*/
 /**
\~english
 * @brief Batch buffer status address [RO]
 * @note This parameter indicates the batch buffer status address.
 * 1. The corresponding pValue/value of this parameter is uint64_t type data.
 */
...
*/
 /**
\~english
 * @brief Burr detection result [RO]
 * @note This parameter indicates the burr detection result.
...
*/
 /**
\~english
 * @brief Burr detection result coordinates [RO]
 * @note This parameter indicates the burr detection result coordinates.
...
*/
 /**
\~english
 * @brief Burr detection debug [RO]
 * @note This parameter indicates burr detection debug.
...
*/
 /**
\~english
 * @brief Buffer payload type [RO]
 * @note This parameter indicates buffer payload type.
 * 1. The corresponding pValue/value of this parameter is uint32_t type data.
 * @see PAYLOAD_TYPE
 */
...
*/
 /**
\~english
 * @brief Buffer image size [RO]
 * @note This parameter indicates buffer image size.
 * 1. The corresponding pValue/value of this parameter is uint32_t type data.
 */
...
*/
 /**
\~english
 * @brief Buffer pixel total depth [RO]
 * @note This parameter indicates buffer pixel total depth.
 * 1. This parameter cannot be set, the value is determined by buffer pixel format ITKBUFFER_PRM_FORMAT .
 * 2. The corresponding pValue/value of this parameter is uint32_t type data.
 */
 ...
 * @note This parameter indicates buffer channel depth.
 * 1. This parameter cannot be set, the value is determined by buffer pixel format ITKBUFFER_PRM_FORMAT .
 * 2. The corresponding pValue/value of this parameter is uint32_t type data.
 */
 ...
 * @note This parameter takes effect in ItkBufferConvert interface.
 * 1. The corresponding pValue/value of this parameter is uint32_t type data.
...
/**
\~chinese
 * @brief Bayer转换成BGR_Plannar格式标志
 * @note 本参数为 ItkBufferBayerConvert 接口的可选option，用于将Bayer格式图像转换为BGR格式图像后，再按通道重新排列成三个区块。
...
/**
\~english
 * @brief a flag convert Bayer to BGR_Plannar
 * @note This parameter is an option for ItkBufferBayerConvert interface, which converts Bayer format images to BGR format and then rearranges them into three blocks by channel.
 ...
 * @see ItkBufferBayerConvert
 */
#define ITKBUFFER_VAL_BAYER_PLANNAR  0x00000100u
...
/**
\~chinese
 * @brief YUV422转换成BGR_Plannar格式标志
 * @note 本参数为 ItkBufferConvert 接口的可选option，用于将YUV422格式图像转换为BGR格式图像后，再按通道重新排列成三个区块。
 * 1. 源缓冲区像素格式为YUV422。
 * 2. 目的缓冲区像素格式为Mono8。
 * 3. 目的缓冲区的图像宽度与源缓冲区一致，图像高度为源缓冲区的3倍。
 * ```
...
/**
\~english
 * @brief a flag convert YUV422 to BGR_Plannar
 * @note This parameter is an option for ItkBufferConvert interface, which converts Bayer format images to YUV422 format and then rearranges them into three blocks by channel.
 ...
 * @see ItkBufferConvert
 */
#define ITKBUFFER_VAL_CONVERT_OPTION_PLANNAR (1 << 28)
...
\~chinese
 * @brief 负载类型
 * @see ItkBufferSizedNew ItkBufferSizedNewWithPtr
*/
 /**
\~english
 * @brief paylaod type
...
enum PAYLOAD_TYPE
{
    ...
    RAW_DATA_PAYLOAD_TYPE                 = 3,   ///< @brief \~chinese 原始数据模式 \~english Raw data mode
    FILE_PAYLOAD_TYPE                     = 4,   ///< @brief \~chinese 文件数据模式 \~english File data mode
    MULTI_PART_PAYLOAD_TYPE               = 5,   ///< @brief \~chinese 多part模式 \~english Multiple parts mode
    GENDC_PAYLOAD_TYPE                    = 6,   ///< @brief \~chinese GENDC模式 \~english GENDC mode
    DEVICE_SPECIFIC_PAYLOAD_TYPE          = 7,   ///< @brief \~chinese 设备特殊模式 \~english Device specific mode
};
...
*/
 /**
\~english
 * @brief Data stream transmission status [RO]
 * @note This parameter indicates data stream transmission status.
 * 1. The corresponding pValue/value of this parameter is uint32_t type data.
...
/**
\~chinese
 * @brief 数据流支持的回调事件类型【RO】
 * @note 本参数表示数据流支持的回调事件类型。
 * 1. 本参数对应的pValue/value为 uint32_t 类型数据。
 * 2. 数据流支持的回调事件类型如下所示：
 * | 数据流支持的回调事件类型                       |
 * |------------------------------------------------|
...
*/
 /**
\~english
 * @brief The callback event types supported by data stream [RO]
 * @note This parameter indicates the callback event types supported by data stream.
 * 1. The corresponding pValue/value of this parameter is uint32_t type data.
...
*/
 /**
\~english
 * @brief Data stream acquisition start mode [RW]
 * @note This parameter indicates data stream acquisition start mode.
...
\~chinese
 * @brief 数据流传输模式【RW】
 * @note 本参数表示数据流传输模式，决定了数据传输过程中下一块传输缓冲区的索引。
 * 1. 本参数对应的pValue/value为 uint32_t 类型数据。
 * 2. 数据流传输模式可选项如下所示：
 * |  数据流传输模式                                      |
 * |------------------------------------------------------|
...
*/
 /**
\~english
 * @brief Data stream transmission mode [RW]
...
*/
 /**
\~english
 * @brief Data stream automatic clearing flag [RW]
 * @note This parameter indicates data stream automatic clearing flag.
 * 1. The corresponding pValue/value of this parameter is uint32_t type data.
...
*/
 /**
\~english
 * @brief Data stream acquisition timeout time [RW]
 * @note This parameter indicates data stream acquisition timeout time.
...
*/
 /**
\~english
 * @brief Real time data stream acquisition frame rate [RO]
 * @note This parameter indicates real time data stream acquisition frame rate.
...
/**
\~chinese
 * @brief 千兆网单个数据包最大重发次数【RW】
 * @note 本参数表示千兆网单个数据包最大重发次数。
...
*/
 /**
\~english
 * @brief Maximum retransmissions number for single packet [RW]
 * @note This parameter indicates maximum retransmissions number for single packet.
...
/**
\~chinese
 * @brief 千兆网单个数据包重传超时时间【RW】
 * @note 本参数表示千兆网单个数据包重传超时时间。
 * 1. 本参数仅对千兆网相机有效，当PC端丢失千兆网数据包后会重新请求丢失的数据包，
 单个数据包请求的超时时间不超过本参数。
 * 2. 本参数对应的pValue/value为 uint32_t 类型数据。
*/
 /**
\~english
 * @brief Gigabit network single packet resend timeout time [RW]
 * @note This parameter indicates gigabit network single packet resend timeout time.
 * 1. This parameter is only valid for gigabit network cameras. When PC loses a gigabit network packet, it will
...
/**
\~chinese
 * @brief 千兆网数据块最大重传包数【RW】
 * @note 本参数表示千兆网数据块最大重传包数。
...
*/
 /**
\~english
 * @brief Maximum number of retransmitted packets for GigEVision data block [RW]
 * @note This parameter indicates maximum number of retransmitted packets for GigEVision data block.
...
/**
\~chinese
 * @brief 千兆网数据块最大等待包数【RW】
 * @note 本参数表示千兆网数据块最大等待包数。
...
*/
 /**
\~english
 * @brief Maximum number of GigEVision data block to wait [RW]
 * @note This parameter indicates maximum number of GigEVision data block to wait.
...
/**
\~chinese
 * @brief 千兆网数据块重传窗口大小【RW】
 * @note 本参数表示千兆网数据块重传窗口大小。
 * 1. 本参数对应的pValue/value为 uint32_t 类型数据。
*/
 /**
\~english
 * @brief Gigabit network data block retransmission window size [RW]
 * @note This parameter indicates gigabit network data block retransmission window size.
 * 1. The corresponding pValue/value of this parameter is uint32_t type data.
 */
...
/**
\~chinese
 * @brief 千兆网单个数据包行间超时时间【RW】
 * @note 本参数表示千兆网单个数据包行间超时时间。
 * 1. 本参数对应的pValue/value为 uint32_t 类型数据。
*/
 /**
\~english
 * @brief Gigabit network single packet inter timeout time [RW]
 * @note This parameter indicates gigabit network single packet inter timeout time.
 * 1. The corresponding pValue/value of this parameter is uint32_t type data.
 */
...
/**
\~chinese
 * @brief 千兆网单个数据包轮询时间【RW】
 * @note 本参数表示千兆网单个数据包轮询时间。
 * 1. 本参数对应的pValue/value为 uint32_t 类型数据。
*/
 /**
\~english
 * @brief Polling time of GigEVision single data packet [RW]
 * @note This parameter indicates polling time of GigEVision single data packet.
 * 1. The corresponding pValue/value of this parameter is uint32_t type data.
 */
...
\~chinese
 * @brief 千兆网内核缓冲区个数【RO】
 * @note 本参数表示千兆网内核缓冲区个数。
 * 1. 本参数对应的pValue/value为 uint32_t 类型数据。
*/
 /**
\~english
 * @brief Count of GigEVision kernel buffer [RO]
 * @note This parameter indicates count of GigEVision kernel buffer.
 * 1. The corresponding pValue/value of this parameter is uint32_t type data.
 */
...
*/
 /**
\~english
 * @brief Data stream line rate [RO]
 * @note This parameter indicates data stream line rate.
 * 1. The corresponding pValue/value of this parameter is float type data.
 */
...
*/
 /**
\~english
 * @brief Burr detection save rate [RO]
 * @note This parameter indicates burr detection save rate.
 * 1. The corresponding pValue/value of this parameter is uint32_t type data.
 */
...
*/
 /**
\~english
 * @brief Burr detection save path [RW]
 * @note This parameter indicates burr detection save path.
...
/**
\~chinese
 * @brief 毛刺检测保存缓冲区个数【RW】
 * @note 本参数表示毛刺检测保存缓冲区个数。
 * 1. 本参数对应的pValue/value为 uint32_t 类型数据。
*/
 /**
\~english
 * @brief Number of buffer for burr detection [RW]
 * @note This parameter indicates number of buffer for burr detection.
 * 1. The corresponding pValue/value of this parameter is uint32_t type data.
 */
...
\~chinese
 * @brief 数据流批量缓冲区大小【RW】
 * @note 本参数表示数据流批量缓冲区大小。
 * 1. 本参数对应的pValue/value为 uint32_t 类型数据。
*/
 /**
\~english
 * @brief Batch buffer size for data stream [RW]
 * @note This parameter indicates batch buffer size for data stream.
 * 1. The corresponding pValue/value of this parameter is uint32_t type data.
 */
...
*/
 /**
\~english
 * @brief Whether data stream parameter adaptive [RW]
 * @note This parameter indicates whether data stream parameter adaptive.
 * 1. The corresponding pValue/value of this parameter is uint32_t type data.
 * 2. The parameter values and descriptions are as follows:
 * | Parameter value  | Description                              |
 * |------------------|------------------------------------------|
...
/**
\~chinese
 * @brief 是否使帧开始对应帧结束【RW】
 * @note 本参数表示是否使帧开始对应帧结束。
 * 1. 本参数对应的pValue/value为 uint32_t 类型数据。
 * 2. 参数取值及描述如下所示：
 * | 参数取值 | 描述                  |
 * |----------|-----------------------|
...
*/
 /**
\~english
 * @brief Whether let the frame start correspond to the frame end [RW]
 * @note This parameter indicates whether let the frame start correspond to the frame end.
 * 1. The corresponding pValue/value of this parameter is uint32_t type data.
 * 2. The parameter values and descriptions are as follows:
 * | Parameter value  | Description                                 |
 * |------------------|---------------------------------------------|
 ...
 * @note This parameter indicates data stream acquisition strategy.
 * 1.The corresponding pValue/value of this parameter is uint32_t type data.
 ...
 * @note 本参数表示采图线程的CPU亲和性。
 * 1. 本参数对应的pValue/value为 uint32_t 类型数据。
*/
 /**
\~english
 * @brief Grab Thread CPU Affinity [WO]
 * @note This parameter indicates grab thread CPU affinity.
 * 1.The corresponding pValue/value of this parameter is uint32_t type data.
 */
...
*/
 /**
\~english
 * @brief Flip view image horizontally [RW]
 * @note This parameter indicates the horizontal flipping of view image.
 * 1. The corresponding pValue/value of this parameter is uint32_t type data.
...
*/
 /**
\~english
 * @brief Flip view image vertically [RW]
 * @note This parameter indicates the vertical flipping of view image.
 * 1. The corresponding pValue/value of this parameter is uint32_t type data.
...
\~chinese
 * @brief 视图图像最低bit位【RW】
 * @note 本参数表示视图图像最低bit位。
 * 1. 本参数对应的pValue/value为 uint32_t 类型数据。
*/
 /**
\~english
 * @brief View image lowest bit [RW]
 * @note This parameter indicates the lowest bit of view image.
 * 1. The corresponding pValue/value of this parameter is uint32_t type data.
 */
...
\~chinese
 * @brief 视图图像最高bit位【RW】
 * @note 本参数表示视图图像最高bit位。
 * 1. 本参数对应的pValue/value为 uint32_t 类型数据。
*/
 /**
\~english
 * @brief View image highest bit [RW]
 * @note This parameter indicates the highest bit of view image.
 * 1. The corresponding pValue/value of this parameter is uint32_t type data.
 */
...
\~chinese
 * @brief 视图图像感兴区域高度【RW】
 * @note 本参数表示视图图像感兴区域高度。
 * 1. 在创建视图窗口的感兴趣区域时，应先设置高度和宽度，再设置上边缘坐标和左边缘坐标。
 * 2. 本参数对应的pValue/value为 uint32_t 类型数据。
*/
 /**
\~english
 * @brief View image ROI height [RW]
 * @note This parameter indicates view image ROI height.
...
\~chinese
 * @brief 视图图像感兴区域宽度【RW】
 * @note 本参数表示视图图像感兴区域宽度。
 * 1. 在创建视图窗口的感兴趣区域时，应先设置高度和宽度，再设置上边缘坐标和左边缘坐标。
 * 2. 本参数对应的pValue/value为 uint32_t 类型数据。
*/
 /**
\~english
 * @brief View image ROI width [RW]
 * @note This parameter indicates view image ROI width.
 * 1. When creating ROI of view window, the height and width should be set first, followed by the upper and left
edge coordinates.
 * 2. The corresponding pValue/value of this parameter is uint32_t type data.
 */
...
/**
\~chinese
 * @brief 视图图像感兴区域左边缘坐标【RW】
 * @note 本参数表示视图图像感兴区域左边缘坐标。
 * 1. 在创建视图窗口的感兴趣区域时，应先设置高度和宽度，再设置上边缘坐标和左边缘坐标。
 * 2. 本参数对应的pValue/value为 uint32_t 类型数据。
*/
 /**
\~english
 * @brief View image ROI left edge coordinates [RW]
 * @note This parameter indicates view image ROI left edge coordinates.
 * 1. When creating ROI of view window, the height and width should be set first, followed by the upper and left
edge coordinates.
 * 2. The corresponding pValue/value of this parameter is uint32_t type data.
 */
...
/**
\~chinese
 * @brief 视图图像感兴区域上边缘坐标【RW】
 * @note 本参数表示视图图像感兴区域上边缘坐标。
 * 1. 在创建视图窗口的感兴趣区域时，应先设置高度和宽度，再设置上边缘坐标和左边缘坐标。
 * 2. 本参数对应的pValue/value为 uint32_t 类型数据。
*/
 /**
\~english
 * @brief View image ROI upper edge coordinates [RW]
 * @note This parameter indicates view image ROI upper edge coordinates.
 * 1. When creating ROI of view window, the height and width should be set first, followed by the upper and left
edge coordinates.
 * 2. The corresponding pValue/value of this parameter is uint32_t type data.
 */
...
*/
 /**
\~english
 * @brief View image scaling method [RW]
 * @note This parameter indicates view image scaling method.
 * 1. The corresponding pValue/value of this parameter is uint32_t type data.
...
\~chinese
 * @brief 视图图像最大放大倍数【RO】
 * @note 本参数表示视图图像最大放大倍数。
 * 1. 本参数对应的pValue/value为 uint64_t 类型数据。
*/
 /**
\~english
 * @brief Maximum magnification of view image [RO]
 * @note This parameter indicates the maximum magnification of view image.
 * 1. The corresponding pValue/value of this parameter is uint64_t type data.
 */
...
\~chinese
 * @brief 视图图像最小缩小倍数【RO】
 * @note 本参数表示视图图像最小缩小倍数。
 * 1. 本参数对应的pValue/value为 uint64_t 类型数据。
*/
 /**
\~english
 * @brief Minimum magnification of view image [RO]
 * @note This parameter indicates the minimum magnification of view image.
 * 1. The corresponding pValue/value of this parameter is uint64_t type data.
 */
...
*/
 /**
\~english
 * @brief View window handle [RO]
 * @note This parameter indicates view window handle.
...
*/
 /**
\~english
 * @brief View window title [RW]
 * @note This parameter indicates view window title.
...
/**
\~chinese
 * @brief 视图图像Bayer格式【RW】
 * @note 本参数表示视图图像Bayer格式。
 * 1. 本参数对应的pValue/value为 uint32_t 类型数据。
...
*/
 /**
\~english
 * @brief View image Bayer format [RW]
 * @note This parameter indicates view image Bayer format.
 * 1. The corresponding pValue/value of this parameter is uint32_t type data.
...
*/
 /**
\~english
 * @brief Current view buffer index [RO]
 * @note This parameter indicates the current view buffer index.
 * 1. The corresponding pValue/value of this parameter is uint32_t type data.
 */
...
typedef struct _itk_feature_base_info {
    ...
    uint8_t     Reserved_8[31];                     ///< @brief \~chinese 预留 \~english Reserved
    ...
    char        Reserved_char[512];                 ///< @brief \~chinese 预留 \~english Reserved 
...
typedef struct _itk_buffer_info {
    ...
    uint8_t         Reserved8[4];           ///< @brief \~chinese 预留 \~english Reserved
    ...
    uint64_t        ValidImageWidth;        ///< @brief \~chinese 当前图像有效宽度 \~english Current frame valid width
    uint64_t        Reserved64[21];         ///< @brief \~chinese 预留 \~english Reserved
...
\~chinese 
 * @brief 缓冲区part信息结构体
 * @see ItkBufferGetPartInfo
*/
 /**
\~english 
 * @brief Information structure of buffer part
 * @see ItkBufferGetPartInfo
 */
typedef struct _itk_buffer_part_info {
    ...
    uint64_t        Reserved[11];      ///< @brief \~chinese 预留 \~english Reserved
...
\~chinese 
 * @brief 动作命令返回信息结构体
 * @see ITK_ACTION_CMD_RESULT_LIST
*/
 /**
\~english 
...
typedef struct _itk_DevEvent_info {
    ...
    void*       eventData;                ///< @brief  \~chinese Event数据(暂无相机支持)                                        \~english Event data, not support
    uint32_t    eventDataLength;          ///< @brief  \~chinese Event数据长度 (暂无相机支持)                                   \~english Event data len, not support
